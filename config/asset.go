...
func assetAntshellCfg() (*asset, error) {
	bytes, err := assetAntshellCfgBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "asset/antshell.cfg", size: 891, mode: os.FileMode(420), modTime: time.Unix(1688620920, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"asset/antshell.cfg": assetAntshellCfg,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"asset": &bintree{nil, map[string]*bintree{
		"antshell.cfg": &bintree{assetAntshellCfg, map[string]*bintree{}},
	}},
}}
